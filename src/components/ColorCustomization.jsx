      ...
      <div className="bg-bg-secondary rounded-lg p-6 border border-border-light">
        ...
        <div className="mt-8 p-6 bg-gradient-to-r from-gray-50 to-blue-50 rounded-2xl border border-gray-200">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <button 
              className="btn-primary text-sm py-3 px-4 rounded-xl font-medium transition-all duration-200 hover:shadow-lg transform hover:scale-105"
              style={{ 
            ...
            <div 
              className="px-4 py-3 rounded-xl text-white text-sm font-medium shadow-md"
