...
select p.id, p.team, s.art, s.dauer, s.abgesessen, s.art, 'FC15'
from (values
  ('Carvalho', 'Gelb-Rote Karte', 1, 1),
  ('Hilton', 'Gelb-Rote Karte', 1, 1),
  ('Yedlin', 'Rote Karte', 2, 2),
  ('Pepe', 'Verletzung', 3, 3),
  ('Totti', 'Verletzung', 3, 3),
  ('Romeron', 'Verletzung', 3, 3),
  ('Hernandez', 'Rote Karte', 2, 2),
  ('Carvalho', 'Rote Karte', 2, 2),
  ('Navarro', 'Rote Karte', 2, 2),
  ('Carvalho', 'Rote Karte', 2, 2),
  ('Maicon', 'Rote Karte', 2, 2),
  ('Kehl', 'Verletzung', 3, 3),
  ('Klose', 'Rote Karte', 2, 2),
  ('Terry', 'Verletzung', 3, 3),
  ('Maicon', 'Verletzung', 3, 3),
  ('Pepe', 'Verletzung', 3, 3),
  ('Lampard', 'Verletzung', 3, 3),
  ('Di Natale', 'Verletzung', 3, 3),
  ('De Sanctis', 'Rote Karte', 2, 2),
  ('Pepe', 'Verletzung', 3, 3),
  ('Navarro', 'Verletzung', 3, 3),
  ('Pepe', 'Verletzung', 3, 3),
  ('Pirlo', 'Verletzung', 3, 3),
  ('Pepe', 'Verletzung', 3, 3),
  ('Töre', 'Gelb-Rote Karte', 1, 1),
  ('Pirlo', 'Verletzung', 3, 3),
  ('Yedlin', 'Verletzung', 3, 3),
  ('Maicon', 'Rote Karte', 2, 2),
  ('Al Muwallad', 'Verletzung', 3, 3),
  ('Odu', 'Verletzung', 3, 3),
  ('Yedlin', 'Rote Karte', 2, 2),
  ('Olic', 'Rote Karte', 2, 2),
  ('Yedlin', 'Rote Karte', 2, 2),
  ('Carvalho', 'Verletzung', 3, 3),
  ('Ferdinand', 'Verletzung', 3, 3),
  ('Keita', 'Gelb-Rote Karte', 1, 1),
  ('Cesar', 'Rote Karte', 2, 2),
  ('Uche', 'Verletzung', 3, 3),
  ('Carvalho', 'Rote Karte', 2, 2),
  ('Evra', 'Gelb-Rote Karte', 1, 1),
  ('Maicon', 'Gelb-Rote Karte', 1, 1),
  ('Carvalho', 'Rote Karte', 2, 2),
  ('Olic', 'Verletzung', 3, 3),
  ('Cesar', 'Rote Karte', 2, 2),
  ('Yedlin', 'Rote Karte', 2, 2),
  ('Ferdinand', 'Verletzung', 3, 3),
  ('Hilton', 'Verletzung', 3, 3),
  ('Pirlo', 'Verletzung', 3, 3),
  ('Ibrahimovic', 'Gelb-Rote Karte', 1, 1),
  ('Maicon', 'Rote Karte', 2, 2),
  ('Touré', 'Rote Karte', 2, 2),
  ('Cavanda', 'Gelb-Rote Karte', 1, 1),
  ('Maicon', 'Rote Karte', 2, 2),
  ('Alex', 'Gelb-Rote Karte', 1, 1),
  ('Cesar', 'Rote Karte', 2, 2),
  ...
  ('Olic', 'Verletzung', 3, 3),
  ('Di Natale', 'Verletzung', 3, 3),
  ('Lee Seung Hyun', 'Verletzung', 3, 3),
  ('Touré', 'Rote Karte', 2, 2),
  ('Mbakogu', 'Verletzung', 3, 3),
  ('Ferdinand', 'Rote Karte', 2, 2),
  ('Cesar', 'Rote Karte', 2, 2),
  ('A. Cole', 'Rote Karte', 2, 2),
  ('Olic', 'Verletzung', 3, 3),
  ('Töre', 'Verletzung', 3, 3),
  ...
  ('Touré', 'Rote Karte', 2, 2),
  ('Uche', 'Verletzung', 3, 3),
  ('Touré', 'Gelb-Rote Karte', 1, 1),
  ('Hilton', 'Verletzung', 3, 3),
  ('Fekir', 'Verletzung', 3, 3),
  ('Lee Seung Hyun', 'Gelb-Rote Karte', 1, 1),
  ('Hilton', 'Gelb-Rote Karte', 1, 1),
  ('Cedrick', 'Verletzung', 3, 3),
  ('Cesar', 'Rote Karte', 2, 2),
  ('Alex', 'Rote Karte', 2, 2),
  ('Alex', 'Rote Karte', 2, 2),
  ('Di Natale', 'Verletzung', 3, 3),
  ...
  ('Yedlin', 'Rote Karte', 2, 2),
  ('Di Natale', 'Verletzung', 3, 3),
  ('Hilton', 'Rote Karte', 2, 2),
  ('Alex', 'Gelb-Rote Karte', 1, 1),
  ('Tevez', 'Verletzung', 3, 3),
  ('Alex', 'Rote Karte', 2, 2),
  ('Hernandez', 'Verletzung', 3, 3),
  ('Keita', 'Rote Karte', 2, 2),
  ('Campagnaro', 'Rote Karte', 2, 2),
  ('Cesar', 'Rote Karte', 2, 2),
  ('Alex', 'Rote Karte', 2, 2),
  ('Keita', 'Rote Karte', 2, 2),
  ('Oduamadi', 'Rote Karte', 2, 2),
  ('Hernandez', 'Verletzung', 3, 3)
